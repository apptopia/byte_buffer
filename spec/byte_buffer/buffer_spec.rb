...
describe ByteBuffer::Buffer do
  ...
  describe '#append/#<<' do
    ...
    it 'handles appending with another byte buffer' do
      buffer.append('hello ').append(described_class.new('world'))
  ...
  describe '#inspect' do
    it 'returns index positions and capacity' do
      buffer.append("12345")
      buffer.inspect.should include("read_pos:0")
      buffer.inspect.should include("write_pos:5")
      buffer.inspect.should match(/capacity:\d+/)
    end
  end
  ...
  describe '#discard' do
    it 'discards the specified number of bytes from the front of the buffer' do
      ...
      buffer.discard(4)
      buffer.should == described_class.new('o world')
    end

    it 'returns the byte buffer' do
      buffer.append('hello world')
      buffer.discard(4).should == described_class.new('o world')
    end
  ...
  describe '#read' do
    ...
    it 'removes the bytes from the buffer' do
      buffer.append('hello')
      buffer.read(3)
      buffer.should == described_class.new('lo')
  ...
  describe '#read_int' do
    ...
    it 'removes the bytes from the buffer' do
      buffer.append("\xca\xfe\xba\xbe\x01")
      buffer.read_int
      buffer.should == described_class.new("\x01")
    end
